        ...
        **TCE Per Month:** Rp {tce_per_month:,.0f} / Month
        ...
        def create_pdf(username):
            ...
            note_data = [
                ...
                ["Fuel Price", f"Rp {price_fuel:,.0f} / Ltr"],
                ["Port Stay POL", f"{port_stay_pol} Days"],
                ["Port Stay POD", f"{port_stay_pod} Days"],
            ]

            t_note = Table(note_data, colWidths=[9*cm, 9*cm])
            ...
            elements += [t_note, Spacer(1, 4)]

            # ===== FOOTER =====
            footer_text = f"Generated by {username} | https://freight-calculatordemo2.streamlit.app/"
